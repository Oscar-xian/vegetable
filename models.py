...
class User(db.Model):
    ...
    vegetables: Mapped[List["Vegetable"]] = relationship("Vegetable", back_populates="publisher")
...
class EmailCode(db.Model):
    ...
    creat_time: Mapped[datetime] = mapped_column(DateTime, default=datetime.now)